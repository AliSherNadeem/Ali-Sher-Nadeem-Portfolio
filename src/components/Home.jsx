      ...
      >
        <div className="flex flex-col justify-center h-full">
          ...
          <p className="text-gray-400 py-4 max-w-md">
            👋 Hi! My name is Ali Sher Nadeem, and I am a recent Software
            Engineering graduate with a strong foundation in web development and
            the MERN Stack.💻 I am passionate about designing and implementing
            responsive web applications and am actively seeking opportunities to
